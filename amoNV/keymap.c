...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    CW_TOGG,        KC_F,           KC_O,           KC_U,           KC_M,           KC_J,                                           KC_TRANSPARENT, KC_G,           KC_D,           KC_P,           KC_Q,           KC_DELETE,      
    ...
    KC_TRANSPARENT, MT(MOD_LCTL, KC_Z),KC_DOT,         KC_COMMA,       KC_L,           KC_X,                                           KC_K,           KC_C,           KC_V,           KC_B,           KC_BSLS,        KC_F5,          
