...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_PERC,        KC_ASTR,        KC_COLN,        KC_DLR,         ST_MACRO_5,                                     KC_CALCULATOR,  KC_KP_7,        KC_KP_8,        KC_KP_9,        KC_E,           KC_TRANSPARENT, 
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_PERC,        KC_ASTR,        KC_COLN,        KC_DLR,         KC_AT,                                          KC_BSLS,        KC_AMPR,        KC_HASH,        KC_EXLM,        KC_TILD,        KC_TRANSPARENT, 
