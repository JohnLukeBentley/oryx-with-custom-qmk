...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    ST_MACRO_0,     KC_EXLM,        KC_AT,          KC_HASH,        KC_DLR,         KC_PERC,                                        KC_CIRC,        KC_AMPR,        KC_ASTR,        KC_UNDS,        KC_TILD,        ST_MACRO_3,     
    ST_MACRO_1,     TD(DANCE_0),    TD(DANCE_1),    MT(MOD_LSFT, KC_SLASH),TD(DANCE_2),    KC_GRAVE,                                       KC_PLUS,        TD(DANCE_3),    TD(DANCE_4),    MT(MOD_LALT, KC_SCLN),TD(DANCE_5),    KC_TRANSPARENT, 
    KC_TRANSPARENT, ST_MACRO_2,     KC_LBRC,        KC_LCBR,        KC_BSLS,        KC_PIPE,                                        KC_NO,          KC_EQUAL,       KC_RCBR,        KC_RBRC,        KC_TRANSPARENT, KC_F12,         
  ...
  [3] = LAYOUT_voyager(
    ...
    ST_MACRO_4,     KC_LABK,        KC_RABK,        KC_MINUS,       KC_COLN,        KC_NO,                                          KC_NO,          KC_KP_7,        KC_KP_8,        KC_KP_9,        KC_NO,          ST_MACRO_6,     
    ST_MACRO_5,     TD(DANCE_6),    MT(MOD_LALT, KC_DOT),MT(MOD_LSFT, KC_SLASH),MT(MOD_LCTL, KC_COMMA),KC_NO,                                          KC_NUM,         KC_KP_4,        KC_KP_5,        KC_KP_6,        KC_KP_0,        KC_TRANSPARENT, 
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [1] = { {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {206,255,253}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {0,0,0}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {206,255,253}, {206,255,253}, {206,255,253}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {0,0,0}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140}, {74,251,140} },

    [2] = { {13,218,204}, {13,218,204}, {13,218,204}, {13,218,204}, {13,218,204}, {13,218,204}, {13,218,204}, {13,218,204}, {206,255,253}, {206,255,253}, {206,255,253}, {13,218,204}, {0,0,0}, {206,255,253}, {206,255,253}, {206,255,253}, {206,255,253}, {206,255,253}, {13,218,204}, {13,218,204}, {206,255,253}, {13,218,204}, {206,255,253}, {13,218,204}, {13,218,204}, {13,218,204}, {0,0,0}, {13,218,204}, {0,0,255}, {13,218,204}, {13,218,204}, {13,218,204}, {0,0,0}, {13,218,204}, {0,0,0}, {13,218,204}, {13,218,204}, {13,218,204}, {0,0,0}, {206,255,253}, {206,255,253}, {206,255,253}, {13,218,204}, {13,218,204}, {0,0,0}, {13,218,204}, {206,255,253}, {13,218,204}, {13,218,204}, {13,218,204}, {13,218,204}, {13,218,204} },

    [3] = { {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,0,0}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,0,0}, {0,0,0}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,0,0}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,0,0}, {0,0,0}, {0,0,0}, {208,184,229}, {0,0,0}, {0,218,204}, {0,218,204}, {0,218,204}, {0,0,0}, {0,218,204}, {0,0,255}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,0,0}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204}, {0,218,204} },
