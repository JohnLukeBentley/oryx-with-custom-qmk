...
#define DUAL_FUNC_2 LT(9, KC_F19)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_LBRC,        KC_PIPE,        KC_BSLS,        KC_LCBR,        KC_TRANSPARENT,                                 KC_NO,          KC_RCBR,        KC_TRANSPARENT, KC_TRANSPARENT, KC_RBRC,        KC_F12,         
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_voyager(
